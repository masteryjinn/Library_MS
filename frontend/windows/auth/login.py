...
from tabs.main_tab import MainWindow
...
class AuthWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('🔐 Авторизація') # Додаємо іконку в заголовок
        self.setFixedSize(330, 340) # Трохи збільшили висоту для вільного простору
    ...
    def login(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                current_user.set_user_data(user_id, name, role, token)
